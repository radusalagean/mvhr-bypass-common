...
#define LOCAL_CONTRACT_CODE_REQUEST_STATE 0x32
#define LOCAL_CONTRACT_CODE_RESPONSE_STATE 0x33

#define LOCAL_CONTRACT_CODE_REQUEST_TEMPERATURES 0x34
#define LOCAL_CONTRACT_CODE_RESPONSE_TEMPERATURES 0x35
